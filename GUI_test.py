...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(self.image_path, "nfa_simulator.png")), size=(900, 250))
        self.home_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(self.image_path, "home_dark.png")),
                                                 dark_image=Image.open(os.path.join(self.image_path, "home_light.png")), size=(30, 30))
        self.chat_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(self.image_path, "chat_dark.png")),
                                                 dark_image=Image.open(os.path.join(self.image_path, "chat_light.png")), size=(30, 30))
        self.add_user_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(self.image_path, "add_user_dark.png")),
                                                     dark_image=Image.open(os.path.join(self.image_path, "add_user_light.png")), size=(30, 30))

        # create navigation frame
        self.navigation_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.navigation_frame.grid(row=0, column=0, rowspan=5, sticky="nsew")
        ...
        # configure grid layout (4x4)
        self.second_frame.grid_columnconfigure((0,1,2,3), weight=1)
        ...
        self.regex_entry = customtkinter.CTkEntry(self.second_frame, placeholder_text="Enter the regular expression here...")
        self.regex_entry.grid(row=0, column=0, columnspan=5, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.input_string_entry = customtkinter.CTkEntry(self.second_frame, placeholder_text="Enter the input string here...")
        self.input_string_entry.grid(row=1, column=0, columnspan=5, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.check_button = customtkinter.CTkButton(self.second_frame, text="Check", command=self.check_event)
        self.check_button.grid(row=2, column=1, padx=(20, 20), pady=(20, 20), sticky="nsew")

        # output frame
        self.nfa_graph_frame = customtkinter.CTkFrame(self.second_frame, corner_radius=20)
        self.nfa_graph_frame.grid(row=3, column=0, columnspan=3, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.nfa_graph_image = customtkinter.CTkImage(Image.open(os.path.join(self.image_path, "nfa_graph.png")), size=(750, 150))
        self.nfa_graph_image_label = customtkinter.CTkLabel(self.nfa_graph_frame, text="", image=self.nfa_graph_image)
        self.nfa_graph_image_label.grid(row=0, column=0, padx=(20, 20), pady=(20, 20))

        self.true_frame = customtkinter.CTkFrame(self.second_frame, corner_radius=20)
        self.true_frame.grid(row=4, column=0, columnspan=4, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.true_image = customtkinter.CTkImage(Image.open(os.path.join(self.image_path, "true.png")), size=(50, 50))
        ...
        self.true_label = customtkinter.CTkLabel(self.true_frame, text="The NFA accepts the input string.", font=customtkinter.CTkFont(size=25, weight="bold"))
        ...
        self.false_frame.grid(row=4, column=0, columnspan=4, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.false_image = customtkinter.CTkImage(Image.open(os.path.join(self.image_path, "false.png")), size=(50, 50))
        ...
        self.false_label = customtkinter.CTkLabel(self.false_frame, text="The NFA does not accept the input string.", font=customtkinter.CTkFont(size=25, weight="bold"))
        ...
        self.invalid_frame.grid(row=4, column=0, columnspan=4, padx=(20, 20), pady=(20, 20), sticky="nsew")
        self.invalid_image = customtkinter.CTkImage(Image.open(os.path.join(self.image_path, "false.png")), size=(50, 50))
        ...
        self.invalid_label = customtkinter.CTkLabel(self.invalid_frame, text="Invalid regular expression.", font=customtkinter.CTkFont(size=25, weight="bold"))
        ...
        self.nfa_graph_frame.grid_remove()
    ...
    def check_event(self):
        ...
        if valide:
            ...
            self.nfa_graph_frame = customtkinter.CTkFrame(self.second_frame, corner_radius=20)
            self.nfa_graph_frame.grid(row=3, column=0, columnspan=3, padx=(20, 20), pady=(20, 20), sticky="nsew")
            self.nfa_graph_image = customtkinter.CTkImage(Image.open(os.path.join(self.image_path, "nfa_graph.png")), size=(900, 200))
            self.nfa_graph_image_label = customtkinter.CTkLabel(self.nfa_graph_frame, text="", image=self.nfa_graph_image)
            self.nfa_graph_image_label.grid(row=0, column=0, padx=(20, 20), pady=(20, 20))

            self.nfa_graph_frame.grid()
        else:
            self.true_frame.grid_remove()
            self.false_frame.grid_remove()
